/**
 * RPMS MULTI-TENANT ENGINE v12.0.0 (DDS + CMS + Settings)
 * Plik: src/integration/skrypty_GAS/main_v7.gs
 * Dodano obsługę Dynamic Design System (DDS).
 */
...
function doPost(e) {
  try {
    ...
    switch(action) {
      ...
      // NOWE AKCJE DDS
      case 'GET_DDS':            return handleGetDDS();
      case 'UPDATE_DDS':         return handleUpdateDDS(payload);
